...
<head>
    ...
    <title>This is Rajkiran Test Site</title>
    <!-- Bootstrap 5 CSS -->
...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <main class="container my-5 flex-grow-1 d-flex flex-column justify-content-center align-items-center">
        <div class="col-lg-8 w-100 p-5 bg-white rounded-4 shadow-sm border text-center">
            <h1 class="display-5 fw-bold text-primary mb-3">This is Rajkiran Test Site</h1>
            <p class="fs-4 text-muted">Jenkins Freestyle Practice</p>
            <p class="mb-5 px-md-5">This is a simple, modern looking dummy application built locally for learning CI/CD deployment to Tomcat 10.x endpoints.</p>
            
            <div class="d-flex justify-content-center gap-3 flex-wrap">
                <a href="hello" class="btn btn-outline-primary btn-lg px-4" id="btnHello">Call Hello Servlet</a>
                <a href="dashboard.jsp" class="btn btn-primary btn-lg px-4 shadow-sm" id="btnDashboard">Go to Dashboard</a>
            </div>
        </div>
    </main>
